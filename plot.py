...
def plot_bandstructure(file_path, fermi_energy, E_min, E_max, kspacing, struct, kpath = 'MGM', filename = 'eucd2as2', colormap = 'viridis', code = 'vasp'):
    ...
    plot_bands_new(data, fermi_energy, E_min, E_max, kspacing, struct, colormap, kpath, filename, code)
